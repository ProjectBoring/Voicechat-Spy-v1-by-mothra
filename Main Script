...
Minimize.BackgroundColor3 = Color3.fromRGB(68, 68, 68)
...
PlayersSC.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
PlayersSC.BackgroundTransparency = 1.000
...
CountLbl.Parent = BG
CountLbl.BackgroundColor3 = Color3.fromRGB(68, 68, 68)
...
PlayerFrame.BackgroundColor3 = Color3.fromRGB(63, 63, 63)
...
PlayersSC.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
    ...
    if NewFrame and NewFrame:FindFirstChild('Button') then
        ...
        NewFrame.Button.MouseButton1Click:Connect(function()
            ...
            if ContinueLoop then
                NewFrame.Button.TextColor3 = Color3.fromRGB(255, 0, 0); ContinueLoop = false
